...
export default function PortalClientPage() {
  ...
  // ?clientId= (vindo da ficha ou da lista) já abre no cliente certo — antes o
  // botão "Portal" caía sempre no primeiro da lista. Lido via useSearchParams,
  // que o Next resolve antes do render: sem divergência de hidratação e sem
